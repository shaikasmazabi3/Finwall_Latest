...
const Analytics = () => {
  ...
  return (
    <div className='p-8'>
        ...
        <Card className='shadow-none ' style={{height:'20rem', backgroundColor:  colors.primary[300] }}>
        </Card>
        ...
        <Card className='shadow-none col-span-4'  style={{height:'20rem', backgroundColor:  colors.primary[300] }}>
        </Card>
        </div>
    </div>
  )
